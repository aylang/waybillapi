...
app.get("/api/powerbi", function (request, response) {
  ...
  collection.find().toArray(function (err, array) {
    ...
    array.forEach(function (item, i, arr) {
      ...
      result += '"dump": "' + item.dump + '", ';
      result += '"driver": "' + item.driver + '", ';
      result += '"loading": "' + item.loading + '", ';
      result += '"unloading": "' + item.unloading + '", ';

      result += '"price": "' + item.price + '", ';
      result += '"revenue": "' + item.revenue + '", ';
      result += '"rateDriver": "' + item.rateDriver + '", ';
      result += '"wageDriver": "' + item.wageDriver + '", ';

      result += '"distance": "' + item.distance + '", ';
      result += '"ton": "' + item.ton + '", ';
      result += '"cube": "' + item.cube + '", ';
      result += '"hour": "' + item.hour + '", ';
      result += '"rides": "' + item.rides + '", ';
      result += "},\n";
    });
    result += "]";
